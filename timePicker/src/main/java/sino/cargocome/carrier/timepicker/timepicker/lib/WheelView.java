package sino.cargocome.carrier.timepicker.timepicker.lib;
...
import sino.cargocome.carrier.timepicker.timepicker.adapter.WheelAdapter;
import sino.cargocome.carrier.timepicker.timepicker.listener.OnItemSelectedListener;
import sino.cargocome.carrier.timepicker.timepicker.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(0.0F, secondLineY + CENTERCONTENTOFFSET, measuredWidth, secondLineY + CENTERCONTENTOFFSET, paintIndicator);
        //单位的Label
        if (label != null) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 60F || angle <= -60F) {
                ...
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    canvas.clipRect(0, 0, measuredWidth, (int) (itemHeight));
                    canvas.scale(1.0F, (float) Math.sin(radian) * SCALECONTENT);
                    canvas.drawText(contentText, drawOutContentStart, maxTextHeight+CENTERCONTENTOFFSET, paintOuterText);
                    canvas.restore();
                }
                canvas.restore();
            }
