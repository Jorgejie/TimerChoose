...
//	}
	...
	public void setPicker(final int year , int month , int day, int h, int m, TimePickerView timePickerView) {
...
//		wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字
		...
		//添加自己的横向的年的监听
		timePickerView.setOnYearChanged(new OnYearChanged() {
			@Override
		...
		OnItemSelectedListener wheelListener_month = new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				...
				if (list_big.contains(String.valueOf(month_num))) {
					...
					if ((/*(wv_year.getCurrentItem() + startYear)*/mCurrentYear % 4 == 0 && /*(wv_year
							.getCurrentItem() + startYear)*/mCurrentYear % 100 != 0)
							|| /*(wv_year.getCurrentItem() + startYear)*/ mCurrentYear% 400 == 0){
						wv_day.setAdapter(new NumericWheelAdapter(1, 29));
						maxItem = 29;
					}
					else{
...
//		wv_year.setOnItemSelectedListener(wheelListener_year);
	...
	public String getTime() {
		StringBuffer sb = new StringBuffer();
			sb.append(/*(wv_year.getCurrentItem() + startYear)*/mCurrentYear).append("-")
